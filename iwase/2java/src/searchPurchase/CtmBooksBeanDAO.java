...
public class CtmBooksBeanDAO {
	...
	public SearchBooksDetalBean getSearchBDB(String hndIsbn) {

		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		SearchBooksDetalBean searchBDB = null;
		...
		try {
			...
			while(rs.next()) {
				...
				searchBDB =
						new SearchBooksDetalBean(isbn,title,author_name,price,info,stock,
								image,publish_name,category_name,sales_date);
				System.out.println(searchBDB+"DAOのsearchBDB");
